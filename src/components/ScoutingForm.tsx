...
export function ScoutingForm({ match, user, onBack, onSubmit, existing }: ScoutingFormProps) {
  ...
  const ScoreButton = ({ label, value, onChange, size = 'md' }: {
    ...
    const btnClass = 'flex-1 min-w-[44px] md:min-w-[64px] h-10 md:h-12 lg:h-14 flex items-center justify-center rounded-md font-semibold select-none text-sm md:text-base';
    ...
    return (
      <div className={outerClass}>
        ...
        <div className="flex items-center justify-center gap-3 flex-wrap">
          ...
          <div className="bg-white border rounded-md px-3 py-1 sm:py-2 flex items-center justify-center flex-shrink-0">
            <span className="text-base md:text-lg lg:text-xl font-bold text-black">{value}</span>
          </div>
            ...
            <h2 className="text-xl font-bold text-gray-900 mb-4">Teleop Period</h2>
              <div className="space-y-4">
                ...
                <div className="border rounded p-3">
                  ...
                  <div className="flex items-center gap-2 w-full sm:w-64 md:w-80 mb-2">
